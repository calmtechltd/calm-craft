...
- **Silently turning on a cooldown or script allowlist.** Those change the next install. Report them; `conventions-decide` is where they get enabled.
