...
Customers receive an invoice through their chosen delivery channel and can recover from a failed address. [Case routing](../../support/cases/case-routing.md) handles any follow-up, using the shared [support vocabulary](../../support/glossary.md).
